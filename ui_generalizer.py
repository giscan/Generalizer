...
class Ui_generalizer(object):
    def setupUi(self, generalizer):
        ...
        self.bOk = QtWidgets.QPushButton(parent=generalizer)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Maximum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.cbAlgorithm = QtWidgets.QComboBox(parent=self.groupBox)
        ...
        self.stackOptions = QtWidgets.QStackedWidget(parent=self.groupBox)
        self.stackOptions.setObjectName("stackOptions")
        self.page_11 = QtWidgets.QWidget()
        self.page_11.setObjectName("page_11")
        self.gridLayout_11 = QtWidgets.QGridLayout(self.page_11)
        self.gridLayout_11.setObjectName("gridLayout_11")
        self.label_12 = QtWidgets.QLabel(parent=self.page_11)
        self.label_12.setObjectName("label_12")
        self.gridLayout_11.addWidget(self.label_12, 0, 0, 1, 1)
        self.sbRemove_thresh = QtWidgets.QDoubleSpinBox(parent=self.page_11)
        ...
        self.sbDP_thresh = QtWidgets.QDoubleSpinBox(parent=self.page_12)
        ...
        self.sbJenks_thresh = QtWidgets.QDoubleSpinBox(parent=self.page_2)
        ...
        self.sbJenks_angle = QtWidgets.QDoubleSpinBox(parent=self.page_2)
        ...
        self.label_13 = QtWidgets.QLabel(parent=self.page_13)
        self.label_13.setObjectName("label_13")
        self.gridLayout_3.addWidget(self.label_13, 0, 0, 1, 1)
        self.sbLang_thresh = QtWidgets.QDoubleSpinBox(parent=self.page_13)
        ...
        self.label_19 = QtWidgets.QLabel(parent=self.page_13)
        self.label_19.setObjectName("label_19")
        self.gridLayout_3.addWidget(self.label_19, 1, 0, 1, 1)
        self.sbLang_LA = QtWidgets.QSpinBox(parent=self.page_13)
        ...
        self.sbRW_thresh = QtWidgets.QDoubleSpinBox(parent=self.page_4)
        ...
        self.label_20 = QtWidgets.QLabel(parent=self.page_14)
        self.label_20.setObjectName("label_20")
        self.gridLayout_14.addWidget(self.label_20, 0, 0, 1, 1)
        self.sbReduction_thresh = QtWidgets.QDoubleSpinBox(parent=self.page_14)
        ...
        self.label_21 = QtWidgets.QLabel(parent=self.page_15)
        self.label_21.setObjectName("label_21")
        self.gridLayout_15.addWidget(self.label_21, 0, 0, 1, 1)
        self.sbBoyle_LA = QtWidgets.QSpinBox(parent=self.page_15)
        ...
        self.label_22 = QtWidgets.QLabel(parent=self.page_16)
        self.label_22.setObjectName("label_22")
        self.gridLayout_16.addWidget(self.label_22, 0, 0, 1, 1)
        self.sbChaiken_level = QtWidgets.QSpinBox(parent=self.page_16)
        ...
        self.label_23 = QtWidgets.QLabel(parent=self.page_16)
        self.label_23.setObjectName("label_23")
        self.gridLayout_16.addWidget(self.label_23, 1, 0, 1, 1)
        self.sbChaiken_weight = QtWidgets.QDoubleSpinBox(parent=self.page_16)
        ...
        self.sbHermite_tightness = QtWidgets.QDoubleSpinBox(parent=self.page)
        ...
        self.sbHermite_steps = QtWidgets.QDoubleSpinBox(parent=self.page)
        ...
        self.label_24 = QtWidgets.QLabel(parent=self.page_17)
        self.label_24.setObjectName("label_24")
        self.gridLayout_17.addWidget(self.label_24, 0, 0, 1, 1)
        self.sbDist_slide = QtWidgets.QDoubleSpinBox(parent=self.page_17)
        ...
        self.label_25 = QtWidgets.QLabel(parent=self.page_17)
        self.label_25.setObjectName("label_25")
        self.gridLayout_17.addWidget(self.label_25, 1, 0, 1, 1)
        self.sbDist_LA = QtWidgets.QSpinBox(parent=self.page_17)
        ...
        self.label_26 = QtWidgets.QLabel(parent=self.page_18)
        self.label_26.setObjectName("label_26")
        self.gridLayout_18.addWidget(self.label_26, 0, 0, 1, 1)
        self.sbSlide_slide = QtWidgets.QDoubleSpinBox(parent=self.page_18)
        ...
        self.label_27 = QtWidgets.QLabel(parent=self.page_18)
        self.label_27.setObjectName("label_27")
        self.gridLayout_18.addWidget(self.label_27, 1, 0, 1, 1)
        self.sbSlide_LA = QtWidgets.QSpinBox(parent=self.page_18)
        ...
        self.sbSnakes_alpha = QtWidgets.QDoubleSpinBox(parent=self.page_3)
        ...
        self.sbSnakes_beta = QtWidgets.QDoubleSpinBox(parent=self.page_3)
        ...
        self.lstLayers = QtWidgets.QListWidget(parent=self.page_10)
        ...
        self.tblBatchAlg = QtWidgets.QTableWidget(parent=self.page_10)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.cbOutDir = QtWidgets.QCheckBox(parent=self.page_10)
        self.cbOutDir.setObjectName("cbOutDir")
        self.gridLayout_21.addWidget(self.cbOutDir, 6, 0, 1, 1)
        self.label_5 = QtWidgets.QLabel(parent=self.page_10)
        self.label_5.setObjectName("label_5")
        self.gridLayout_21.addWidget(self.label_5, 2, 0, 1, 1)
        self.label_6 = QtWidgets.QLabel(parent=self.page_10)
        ...
        self.bCancel.clicked.connect(generalizer.close) # type: ignore
    ...
    def retranslateUi(self, generalizer):
        ...
        self.label_3.setText(_translate("generalizer", "Algorithm:"))
        ...
        self.cbAlgorithm.setItemText(4, _translate("generalizer", "Jenks\' Algorithm"))
        ...
        self.label_19.setText(_translate("generalizer", "Look ahead:"))
        ...
        self.label_4.setText(_translate("generalizer", "Tightness:"))
